  ...
  return (
    <nav className="nav-menu-mobile">
      <ul className="menu">
        ...
        />
        <FunctionLink href={`/${sport}/favorites`} activeClassName={activeClass} htmlText={t(ResourceKey.FAVORITES)} iconClassName="icon-menu-favorites" />
        <FunctionLink href={`/${sport}/leagues`} activeClassName={activeClass} htmlText={t(ResourceKey.LEAGUES)} iconClassName="icon-menu-leagues" />
        <FunctionLink href={`/${sport}/news`} activeClassName={activeClass} htmlText={t(ResourceKey.NEWS)} iconClassName="icon-menu-news" />
